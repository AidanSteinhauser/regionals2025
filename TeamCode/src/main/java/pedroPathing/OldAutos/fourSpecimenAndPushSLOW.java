...
@Disabled
@Autonomous(name = "fourSpecimenAndPushSLOW", group = "Regionals")
public class fourSpecimenAndPushSLOW extends OpMode {
    ...
    private final Pose thirdPosePrePushControlTwo = new Pose(80, 102.5, Math.toRadians(0));
    ...
    private final Pose twentyFirstPostPoseIntakeThree = new Pose(126.5, 113, Math.toRadians(90));
