...
@Disabled
@Autonomous(name = "SiSpecV4", group = "Meet3")
public class SiSpecV4 extends OpMode {
    ...
    private final Pose sixthPose = new Pose(87, 115, Math.toRadians(0));
    private final Pose seventhPose = new Pose(133, 115, Math.toRadians(0));
    private final Pose eighthPose = new Pose(87, 115, Math.toRadians(0));
    private final Pose ninthPose = new Pose(87, 127, Math.toRadians(0));
    private final Pose tenthPose = new Pose(133, 127, Math.toRadians(0));
    private final Pose eleventhPose = new Pose(110, 127, Math.toRadians(90));
