...
@Disabled
@Autonomous(name = "SiSpecV3", group = "Meet3")
public class SiSpecV3 extends OpMode {
    ...
    private final Pose sixthPose = new Pose(87, 117, Math.toRadians(0));
    private final Pose seventhPose = new Pose(133, 117, Math.toRadians(0));
    private final Pose eighthPose = new Pose(87, 117, Math.toRadians(0));
