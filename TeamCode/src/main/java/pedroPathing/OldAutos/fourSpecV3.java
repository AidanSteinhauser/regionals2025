...
@Disabled
@Autonomous(name = "fourSpecV3", group = "Meet3")
public class fourSpecV3 extends OpMode {
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 18:
                if (!follower.isBusy()) {
                    if(follower.getPose().getX() > (ninteenthPose.getX() - 1) && follower.getPose().getY() > (ninteenthPose.getY() - 1)) {
