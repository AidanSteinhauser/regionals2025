...
@Disabled
@Autonomous(name = "fiveSpecV1", group = "Meet3")
public class fiveSpecV1 extends OpMode {
    ...
    private final Pose thirdPose = new Pose(120, 107, Math.toRadians(0));
    private final Pose fourthPose = new Pose(82, 120, Math.toRadians(0));
    ...
    private final Pose eighthPose = new Pose(82, 135, Math.toRadians(0));
    private final Pose ninthPose = new Pose(130, 135, Math.toRadians(0));
    private final Pose tenthPose = new Pose(135.65, 120, Math.toRadians(90));
    private final Pose eleventhPose = new Pose(105, 74, Math.toRadians(270));
    private final Pose twelfthPose = new Pose(130, 120, Math.toRadians(90));
    private final Pose thirteenthPose = new Pose(135.65, 120, Math.toRadians(90));
    private final Pose fourteenthPose = new Pose(105, 72, Math.toRadians(270));
    private final Pose fifteenthPose = new Pose(130, 120, Math.toRadians(90));
    private final Pose sixteenthPose = new Pose(135.65, 120, Math.toRadians(90));
    private final Pose seventeenthPose = new Pose(105, 70, Math.toRadians(270));
    private final Pose eighteenthPose = new Pose(130, 120, Math.toRadians(90));
    private final Pose ninteenthPose = new Pose(135.65, 120, Math.toRadians(90));
    private final Pose twentiethPose = new Pose(105, 68, Math.toRadians(270));
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            case 0:
                ...
                break;
            case 1:
                if(follower.getPose().getX() > (secondPose.getX() - 1) && follower.getPose().getY() > (secondPose.getY() - 1)) {
                        follower.followPath(action2, true);
                        setPathState(2);
                }
                break;
            case 2:
                if(follower.getPose().getX() > (thirdPose.getX() - 1) && follower.getPose().getY() > (thirdPose.getY() - 1)) {
                        follower.followPath(action3, true);
                        setPathState(3);
                }
                break;
            case 3:
                if(follower.getPose().getX() > (fourthPose.getX() - 1) && follower.getPose().getY() > (fourthPose.getY() - 1)) {
                        follower.followPath(action4, true);
                        setPathState(4);
                }
                break;
            case 4:
                if(follower.getPose().getX() > (fifthPose.getX() - 1) && follower.getPose().getY() > (fifthPose.getY() - 1)) {
                    follower.followPath(action5,true);
                    setPathState(5);
                }
                break;
            case 5:
                if(follower.getPose().getX() > (sixthPose.getX() - 1) && follower.getPose().getY() > (sixthPose.getY() - 1)) {
                ...
                break;
            case 6:
                if(follower.getPose().getX() > (seventhPose.getX() - 1) && follower.getPose().getY() > (seventhPose.getY() - 1)) {
                    follower.followPath(action7,true);
                    setPathState(7);
                }
                break;
            case 7:
                if(follower.getPose().getX() > (eighthPose.getX() - 1) && follower.getPose().getY() > (eighthPose.getY() - 1)) {
                    follower.followPath(action8,true);
                    setPathState(8);
                }
                break;
            case 8:
                if(follower.getPose().getX() > (ninthPose.getX() - 1) && follower.getPose().getY() > (ninthPose.getY() - 1)) {
                    follower.followPath(action9,true);
                    setPathState(9);
                }
                break;
            case 9:
                if(follower.getPose().getX() > (tenthPose.getX() - 1) && follower.getPose().getY() > (tenthPose.getY() - 1)) {
                    follower.followPath(action10,true);
                    setPathState(10);
                }
                break;
            case 10:
                if(follower.getPose().getX() > (eleventhPose.getX() - 1) && follower.getPose().getY() > (eleventhPose.getY() - 1)) {
                    follower.followPath(action11,true);
                    setPathState(11);
                }
                break;
            case 11:
                if(follower.getPose().getX() > (twelfthPose.getX() - 1) && follower.getPose().getY() > (twelfthPose.getY() - 1)) {
                    follower.followPath(action12,true);
                    setPathState(12);
                }
                break;
            case 12:
                if(follower.getPose().getX() > (thirteenthPose.getX() - 1) && follower.getPose().getY() > (thirteenthPose.getY() - 1)) {
                    follower.followPath(action13,true);
                    setPathState(13);
                }
                break;
            case 13:
                if(follower.getPose().getX() > (fourteenthPose.getX() - 1) && follower.getPose().getY() > (fourteenthPose.getY() - 1)) {
                    follower.followPath(action14,true);
                    setPathState(14);
                }
                break;
            case 14:
                if(follower.getPose().getX() > (fifteenthPose.getX() - 1) && follower.getPose().getY() > (fifteenthPose.getY() - 1)) {
                    follower.followPath(action15,true);
                    setPathState(15);
                }
                break;
            case 15:
                if(follower.getPose().getX() > (sixteenthPose.getX() - 1) && follower.getPose().getY() > (sixteenthPose.getY() - 1)) {
                    follower.followPath(action16,true);
                    setPathState(16);
                }
                break;
            case 16:
                if(follower.getPose().getX() > (seventeenthPose.getX() - 1) && follower.getPose().getY() > (seventeenthPose.getY() - 1)) {
                    follower.followPath(action17,true);
                    setPathState(17);
                }
                break;
            case 17:
                if(follower.getPose().getX() > (eighteenthPose.getX() - 1) && follower.getPose().getY() > (eighteenthPose.getY() - 1)) {
                    follower.followPath(action18,true);
                    setPathState(18);
                }
                break;
            case 18:
                if(follower.getPose().getX() > (ninteenthPose.getX() - 1) && follower.getPose().getY() > (ninthPose.getY() - 1)) {
                    follower.followPath(action19,true);
                    setPathState(19);
                }
                break;
            case 19:
                if(follower.getPose().getX() > (twentiethPose.getX() - 1) && follower.getPose().getY() > (twentiethPose.getY() - 1)) {
                    follower.followPath(action20,true);
                    setPathState(20);
                }
                break;
            case 20:
                if(follower.getPose().getX() > (twentyfirstPose.getX() - 1) && follower.getPose().getY() > (twentyfirstPose.getY() - 1)) {
                    setPathState(-1);
                }
                break;
        }
