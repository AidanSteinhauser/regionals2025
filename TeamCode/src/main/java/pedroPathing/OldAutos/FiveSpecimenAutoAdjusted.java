...
@Disabled
@Autonomous(name = "FiveSpecimenAutoAdjusted", group = "Meet3")
public class FiveSpecimenAutoAdjusted extends OpMode {
    ...
    private final Pose sixthPose = new Pose(87, 118, Math.toRadians(0));
    private final Pose seventhPose = new Pose(133, 118, Math.toRadians(0));
    private final Pose eighthPose = new Pose(83, 118, Math.toRadians(0));
    private final Pose ninthPose = new Pose(83, 130, Math.toRadians(0));
    ...
    private final Pose twelfthPose = new Pose(135.65, 120, Math.toRadians(90));
    private final Pose thirteenthPose = new Pose(115, 74, Math.toRadians(270));
    private final Pose fourteenthPose = new Pose(111, 74, Math.toRadians(270));
    ...
    private final Pose seventeenthPose = new Pose(115, 72, Math.toRadians(270));
    private final Pose eighteenthPose = new Pose(108, 72, Math.toRadians(270));
    private final Pose ninteenthPose = new Pose(130, 120, Math.toRadians(90));
    private final Pose twentiethPose = new Pose(135.65, 120, Math.toRadians(90));
    private final Pose twentyfirstPose = new Pose(115, 70, Math.toRadians(270));
    private final Pose twentysecondPose = new Pose(111, 70, Math.toRadians(270));
    private final Pose twentythirdPose = new Pose(130, 120, Math.toRadians(90));
    private final Pose twentyfourthPose = new Pose(135.65, 120, Math.toRadians(90));
    private final Pose twentyfifthPose = new Pose(115, 68, Math.toRadians(270));
    private final Pose twentysixthPose = new Pose(111, 68, Math.toRadians(270));
