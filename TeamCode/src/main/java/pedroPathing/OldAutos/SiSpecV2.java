...
@Disabled
@Autonomous(name = "SiSpecV2", group = "Meet3")
public class SiSpecV2 extends OpMode {
    ...
    private final Pose sixthPose = new Pose(87, 119, Math.toRadians(0));
    private final Pose seventhPose = new Pose(133, 119, Math.toRadians(0));
    private final Pose eighthPose = new Pose(87, 119, Math.toRadians(0));
    ...
    private final Pose twelfthPose = new Pose(136, 120, Math.toRadians(90));
    private final Pose thirteenthPose = new Pose(113, 74, Math.toRadians(270));
    private final Pose fourteenthPose = new Pose(108, 74, Math.toRadians(270));
    ...
    private final Pose seventeenthPose = new Pose(113, 72, Math.toRadians(270));
    ...
    private final Pose twentiethPose = new Pose(134, 120, Math.toRadians(90));
    private final Pose twentyfirstPose = new Pose(113, 70, Math.toRadians(270));
